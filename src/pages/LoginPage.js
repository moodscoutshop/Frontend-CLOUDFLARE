    ...
    <div className="min-h-screen bg-[#FDFDF8] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1D1F20]">Welcome back</h1>
          <p className="text-[#5D5F60] mt-1">Sign in to access your search history</p>
        </div>
        ...
        <div className="bg-white border border-[#E0DCCE] rounded-2xl p-8 shadow-sm">
          ...
          <p className="text-center text-sm text-[#5D5F60] mt-6">
            ...
            <Link to="/signup" className="text-[#EB9D2A] font-medium hover:underline">
              Sign up
            </Link>
          </p>
        </div>
